...
#Date of Birth
dob="10/January/1991"
date_dob = as.Date(dob, format="%d/%b/%Y")
dob
class(date_dob)
format(date_dob, format="%A") # Date -> Day

#Days passed till today (number of days alive)
Sys.Date() - date_dob

#Difference of DoB & Another date
as.Date("27/July/2017", format= "%d/%b/%Y") - date_dob
